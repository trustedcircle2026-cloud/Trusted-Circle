...
export default function App(){
 ...
 const emailHref=`mailto:promoter@trustedcircle.in?subject=${encodeURIComponent(`Trusted Circle Order ${orderForContact.OrderNumber||''}`)}&body=${encodeURIComponent(orderText)}`
