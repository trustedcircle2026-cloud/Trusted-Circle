...
export default function App(){
 ...
 {route.path==='profile'&&user&&<ProfilePage user={user} name={profileName} setName={setProfileName} onSave={saveProfile} onLogout={logout} onOrders={()=>navigate('orders')} sessionActive={sessionActive}/>}
