...
export default function App(){
 ...
 {route.path==='order-placed'&&<OrderPlacedPage order={lastOrder} token={token} onRetryPayment={retryOrderPayment} onOrders={()=>navigate('orders')} onShop={()=>navigate('vouchers')}/>} {route.path==='info'&&<InfoPage type={route.id||'about'} onNavigate={navigate}/>} 
