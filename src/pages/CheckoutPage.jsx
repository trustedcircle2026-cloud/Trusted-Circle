...
const methods = [
  { id: 'upi', label: 'UPI', icon: Smartphone, hint: 'Google Pay, PhonePe, Paytm & more' },
  { id: 'cards', label: 'Cards', icon: CreditCard, hint: 'Credit & Debit Cards' },
  { id: 'netbanking', label: 'Netbanking', icon: Landmark, hint: 'All major banks' },
  { id: 'wallet', label: 'Wallet', icon: WalletCards, hint: 'Supported wallets' },
  { id: 'link', label: 'Payment Link', icon: Link2, hint: 'Secure payment link' },
]
  ...
  return <main className="checkout-gateway-page">
    ...
    <div className="gateway-shell">
      <aside className="gateway-summary">
        ...
        <div className="gateway-price-label">PRICE SUMMARY</div><div className="gateway-total">{money(total)}</div>
