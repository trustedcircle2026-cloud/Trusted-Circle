/**
 * Trusted Circle Books — production Google Sheet setup helper.
 * Run booksSetupProduction_() once after Config.gs + Code.gs are added.
 */
function booksSetupProduction_() {
  ...
  ss.setActiveSheet(ss.getSheetByName('Organisations'));
