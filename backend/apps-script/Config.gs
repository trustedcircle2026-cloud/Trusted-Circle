...
const TC_CONFIG = Object.freeze({
  ...
  ADMIN_EMAIL: 'trustedcircle2026@gmail.com',
  SHEETS: {
    USERS: 'Users', OTP: 'OTP', SESSIONS: 'UserSessions', AUDIT: 'AuditLogs', PRODUCTS: 'Products', BRANDS: 'Brands', CART: 'Cart', ORDERS: 'Orders', ORDER_ITEMS: 'OrderItems', PAYMENTS: 'Payments', PAYMENT_LINKS: 'PaymentLinks', VOUCHERS: 'Vouchers', NOTIFICATIONS: 'Notifications'
  }
});
